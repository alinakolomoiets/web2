...
function App() {
  ...
  useEffect(() => {
    if (start !== "" && end !== "") {
      fetch("https://localhost:7104/nordpool/" + chosenCountry + "/" + start + "/" + end)
        .then(res => res.json())
        .then(json => {
          setPrices(json);
        });
  ...
  useEffect(() => {
    fetch("https://localhost:7104/nordpool/" + chosenCountry)
      .then(res => res.json())
      .then(json => {
        setPrices(json);
      });
  ...
  useEffect(() => {
    fetch("https://localhost:7104/parcelmachine")
      .then(res => res.json())
      .then(json => setPakiautomaadid(json));
  }, []);
  useEffect(() => {
    fetch("https://localhost:7104/Tooted")
      .then(res => res.json())
      .then(json => setTooted(json));
  }, []);

  function kustuta(index) {
    fetch("https://localhost:7104/Tooted/kustuta/" + index, {"method": "DELETE"})
      .then(res => res.json())
      .then(json => setTooted(json));
  }
  ...
  function lisa() {
    ...
    fetch("https://localhost:7104/Tooted/lisa/", {"method": "POST", "body": JSON.stringify(uusToode)})
      .then(res => res.json())
      .then(json => setTooted(json));
  }
  ////////////////////////
  ...
  function dollariteks() {
    const kurss = 1.1;
    fetch("https://localhost:7104/Tooted/hind-dollaritesse/" + kurss, {"method": "PATCH"})
      .then(res => res.json())
      .then(json => setTooted(json));
  }
